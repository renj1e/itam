! function(t) {
    ...
    t("#side-menu").metisMenu(), t("#vertical-menu-btn").on("click", function(e) {
        ...
        }), t(".right-bar-modal-toggle").on("click", function(e) {
            t("body").toggleClass("right-bar-modal-enabled")
            ...
            //s0 < t(e.target).closest(".right-bar-modal-toggle").length || t("body").removeClass("right-bar-modal-enabled")
